        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {partnersData.map((partner) => (
              <div
                key={partner.id}
                className="group relative bg-white rounded-2xl overflow-hidden border border-gray-200/90 hover:border-[#0f766e]/60 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between"
              >
                {/* Top Accent Bar */}
                <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#01083f] via-[#0f766e] to-[#ffcc00] opacity-0 group-hover:opacity-100 transition-opacity z-10" />

                <div>
                  {/* College Image Postcard Header */}
                  {partner.image && (
                    <div className="relative h-48 w-full overflow-hidden bg-gray-100">
                      ...
                      <div className="absolute bottom-2.5 left-3 right-3 flex items-center justify-between text-white">
                        <span className="px-2.5 py-1 rounded-md text-[10px] font-bold bg-[#01083f]/85 backdrop-blur-sm text-white border border-white/20">
                          {partner.type}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="p-4 sm:p-5">
                    {/* Badge & Icon (shown when no image) */}
                    {!partner.image && (
                    ...
                    {/* Address / Location */}
                    <p className="text-xs text-gray-500 flex items-start gap-1.5 font-medium leading-relaxed">
                      <MapPin className="w-3.5 h-3.5 text-[#0f766e] flex-shrink-0 mt-0.5" />
                ...
                {/* Footer Stats & Tag */}
                <div className="mx-4 sm:mx-5 py-3 border-t border-gray-100 flex items-center justify-between text-xs">
                  <span className="font-semibold text-[#0f766e] flex items-center gap-1">
                    <Users className="w-3.5 h-3.5" />
                    {partner.studentsImpacted}
                  </span>
                  <span className="text-gray-500 font-medium bg-gray-50 px-2.5 py-1 rounded-md border border-gray-100">
                    {partner.tag}
                  </span>
                </div>
              </div>
