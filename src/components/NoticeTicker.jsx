...
export const NoticeTicker = () => {
  return (
    <div className="bg-[#01083f] text-[#ffcc00] border-b border-[#ffcc00]/20 py-2 px-4 overflow-hidden relative text-xs sm:text-sm font-medium flex items-center z-40">
      <div className="flex-shrink-0 flex items-center gap-1.5 bg-[#01083f] pr-3 z-10 font-bold text-white border-r border-gray-700">
